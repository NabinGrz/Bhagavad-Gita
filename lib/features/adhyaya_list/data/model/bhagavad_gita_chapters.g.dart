...
_$BhagavadGitaChapterImpl _$$BhagavadGitaChapterImplFromJson(
        Map<String, dynamic> json) =>
    _$BhagavadGitaChapterImpl(
      id: json['id'] as int,
...
Map<String, dynamic> _$$BhagavadGitaChapterImplToJson(
        _$BhagavadGitaChapterImpl instance) =>
    <String, dynamic>{
      'id': instance.id,
      'name': instance.name,
      'slug': instance.slug,
